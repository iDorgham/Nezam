...
description: Route tasks to the cheapest available CLI tool. Save Codex/Cursor tokens for reasoning tasks.
version: 1.0.0
updated: 2026-05-10
changelog: []
---
...
| Task Type | Primary CLI | Fallback | Never Use Codex/Cursor For |
|---|---|---|---|
...
| Translation drafts (Arabic) | `qwen` (multilingual free) | Gemini | First-pass translations before Codex review |
...
| Research / reasoning | Codex (Cursor) | Antigravity | Complex decisions, architecture, strategy |
| SPEC.md generation | Codex (Cursor) | Antigravity | Feature spec writing (requires reasoning) |
...
- File scanning 500 files: ~15k tokens saved per run vs Codex
