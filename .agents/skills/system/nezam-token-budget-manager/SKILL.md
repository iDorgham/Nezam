...
description: Minimize token spend across Codex, Cursor, Antigravity, and Codex through caching, compression, and routing.
version: 2.0.0
updated: 2026-05-10
changelog: []
---
...
### Codex (Anthropic API / Cowork)
- Use prompt caching for: AGENTS.md, MEMORY.md, CONTEXT.md, active SPEC.md (these are re-read every session)
