...
# Inputs
- `docs/DESIGN.md` component anatomy and visual behavior.
...
9. Validate naming and usage consistency against `docs/DESIGN.md`.
...
- `docs/core/required/features/<id>-<slug>/COMPONENT_API.md` (API contract)
...
- `docs/DESIGN.md`: update when variants/states are added or removed.
