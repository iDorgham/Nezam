...
# Inputs
- `docs/DESIGN.md` motion language and interaction narratives.
...
9. Document choreography and fallback behavior in `docs/DESIGN.md` and component stories.
...
- `docs/DESIGN.md`: keep motion and fallback sections synchronized.
