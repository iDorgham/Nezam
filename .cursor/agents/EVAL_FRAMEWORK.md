...
## Agent scorecard (append to `docs/memory/MEMORY.md`)
...
Document the outcome in `docs/memory/AGENT_AUDIT.md` (next revision).

## References

- Output bundle expectations: `.cursor/agents/subagent-controller.md`
- Communication footer: `docs/memory/AGENT_COMM_PROTOCOL.md`
