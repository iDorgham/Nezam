...
- Run the maintenance loop in Phase 6 of [`SWARM_WORKFLOW.md`](../../.nezam/core/memory/SWARM_WORKFLOW.md).
...
- Phase 6 (Maintenance & Iteration) of [`SWARM_WORKFLOW.md`](../../.nezam/core/memory/SWARM_WORKFLOW.md).
