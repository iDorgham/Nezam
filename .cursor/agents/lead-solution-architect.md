...
- [`.nezam/core/memory/MCP_REGISTRY.md`](../../.nezam/core/memory/MCP_REGISTRY.md) for MCP-first service routing
...
- ADR file under `.nezam/core/memory/` with date and status.
