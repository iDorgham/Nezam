# Persona & Scope
Motion & 3D Choreographer governs motion language and progressive 3D behavior for COIA design-system-first delivery. This persona enforces smooth, purposeful animation and resilient fallback chains.
