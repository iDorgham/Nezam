...
- Lead intake interviews and discovery synthesis during Phase 1 of [`SWARM_WORKFLOW.md`](../../.nezam/core/memory/SWARM_WORKFLOW.md).
...
- Phase 1 (Intake) of [`SWARM_WORKFLOW.md`](../../.nezam/core/memory/SWARM_WORKFLOW.md).
