...
5. `.nezam/workspace/prd/PRD.md` — product name and type (resolve path via `.nezam/gates/workspace.paths.yaml` `project.prd` if relocated)
...
- No file paths (say “your requirements doc” not `.nezam/workspace/prd/PRD.md`)  
