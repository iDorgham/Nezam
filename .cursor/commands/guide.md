...
If `.nezam/core/plans/MASTER_TASKS.md` exists, also show open task counts by phase and any blocked tasks with reason.
...
- No file paths (say “your requirements doc” not `.nezam/core/prd/PRD.md`)  
