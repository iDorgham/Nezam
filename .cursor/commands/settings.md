...
Tool context reference: `.nezam/core/memory/CLI_TOOLS_CONTEXT.md`
...
1. Scan `.nezam/core/plans/MASTER_TASKS.md` for `original_tool: <tool>`.
...
Routing Configuration
  ...
  View full routing matrix: .nezam/core/memory/CLI_TOOLS_CONTEXT.md
```
...
MCP Server Status
  ...
  Full registry: .nezam/core/memory/MCP_REGISTRY.md
```
...
Creates: `.nezam/core/memory/settings-backup-YYYY-MM-DD.yaml`
...
Docs: `.nezam/core/plans/design/DESIGN_SKILLS.md`
