...
- `.nezam/core/gates/hardlock-paths.json` exists
...
Run: `node .nezam/core/scripts/changelog/ensure-changelog-initialized.js`
...
Run: `bash .nezam/core/scripts/checks/check-onboarding-readiness.sh`
