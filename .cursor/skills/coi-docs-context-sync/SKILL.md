...
# Purpose
Keep `docs/context/`, `WORKSPACE_INDEX.md`, and `plan/` artifacts synchronized so project memory and navigation remain current across SDD phases.

# Inputs
- Changed file list from current branch.
- `docs/context/` files (`workspace.md`, `project.md`, `MEMORY.md`, `WORKSPACE_INDEX.md`).
- Plan artifacts (`plan/INDEX.md`, phase `TASKS.md` files).
...
2. Update `docs/context/WORKSPACE_INDEX.md` tables and references for added/removed capabilities.
3. Refresh `docs/context/workspace.md` and `docs/context/project.md` summaries for current scope and state.
4. Log durable decisions and milestones in `docs/context/MEMORY.md`.
5. Sync active execution metadata in `plan/INDEX.md` and related phase task boards.
...
# Output Format
- Updated `docs/context/*` files and `plan/INDEX.md` changes.
