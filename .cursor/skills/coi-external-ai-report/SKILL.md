...
# COIA — External companion progress report

Use with `/SAVE report` or end-of-milestone dev updates.

## Target file

`reports/PROGRESS_REPORT.latest.md` — short, factual, timestamped. Older snapshots optional in `reports/history/`.
