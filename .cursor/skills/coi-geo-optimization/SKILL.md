...
- `docs/specs/sdd/SEO_RESEARCH.md` keyword and entity tables.
- `docs/specs/sdd/IA_CONTENT.md` page-level outlines.
...
7. Validate against AI overviews tooling and capture appearance evidence in `docs/reports/`.
...
- `docs/specs/sdd/ENTITY_INVENTORY.md` (entity → URL → external authority).
