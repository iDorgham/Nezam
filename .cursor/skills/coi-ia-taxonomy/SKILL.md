...
- Keyword and intent map from `docs/specs/sdd/SEO_RESEARCH.md`.
...
2. Author `docs/specs/sdd/IA_CONTENT.md`: top-level nav, secondary nav, footer, utility nav.
...
- `docs/specs/sdd/IA_CONTENT.md` (nav map, URL hierarchy, breadcrumb spec).
