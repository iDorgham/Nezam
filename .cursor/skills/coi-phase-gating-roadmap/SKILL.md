...
- `plan/INDEX.md` traceability matrix.
- Existing artifacts under `docs/specs/sdd/`, `docs/specs/features/`, `DESIGN.md`.
- Versioning policy `docs/specs/sdd/VERSIONING.md`.
...
7. Update `plan/INDEX.md` with phase status; surface next legal `/COMMAND`.
...
- `plan/INDEX.md` status update (markdown table).
