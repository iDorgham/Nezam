...
- Data inventory + flow map from `docs/specs/sdd/`.
...
1. Build data inventory: data class (PII, PHI, sensitive), source, processor, retention, region; document in `docs/specs/sdd/DATA_INVENTORY.md`.
...
- `docs/specs/sdd/DATA_INVENTORY.md`.
- `docs/specs/sdd/PRIVACY_POLICY_INPUTS.md` (legal-ready draft).
