...
- `docs/prompts/PROJECT_PROMPT.md` (north-star + guardrails).
- `docs/CONSTITUTION.md` if present.
- Stakeholder list, capacity model, time horizon, regulatory constraints.
- External market signals (browser companion progress reports under `docs/reports/`).
...
6. Write `plan/MASTER_TASKS.md` outcomes/metrics/risk summary; cross-link to `plan/INDEX.md` traceability matrix.
...
- `plan/MASTER_TASKS.md` (objectives, KPIs, risk summary).
- `plan/INDEX.md` (MT/PT traceability matrix, phase-gate map).
