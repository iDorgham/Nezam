...
- Keyword clusters from `docs/specs/sdd/SEO_RESEARCH.md`.
...
1. Identify hub topics (broad pillars) and spoke topics (specific subtopics) from keyword clusters; document in `docs/specs/sdd/TOPICAL_MAP.md`.
...
7. Validate via crawl tools and log file checks; document outcomes in `docs/reports/`.
...
- `docs/specs/sdd/TOPICAL_MAP.md` (hub list, spokes, internal links).
