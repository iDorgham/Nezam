...
- `DESIGN.md` example pages and interaction states.
- Brand voice from `docs/prompts/PROJECT_PROMPT.md`.
...
- `docs/specs/sdd/UX_FLOWS.md` (flow diagrams, states, copy, a11y mapping).
...
- Pairs with `@.cursor/skills/coi-ia-taxonomy/SKILL.md`, `@.cursor/skills/coi-component-library-api/SKILL.md`, `@.cursor/skills/coi-a11y-automation/SKILL.md`.
