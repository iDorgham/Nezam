...
1. `.nezam/core/plans/design/MOTION_CONTRACT.md` — duration, easing, token map, 2-variation pairs.
2. `.nezam/core/plans/design/INTERACTION_STATES.md` — visual and motion specs for all interactive components.
