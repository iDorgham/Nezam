...
### Output Artifacts
1. `.nezam/core/plans/design/WIREFRAMES.md`: Full wireframes and specs (both variations).
2. `.nezam/core/plans/design/DESIGN_CHOICES.yaml`: Locked selection data.
3. `.nezam/core/plans/design/COMPONENT_INVENTORY.md`: Every component, variant, and state.
