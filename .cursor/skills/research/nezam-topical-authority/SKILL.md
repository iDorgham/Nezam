...
7. Validate via crawl tools and log file checks; document outcomes in `.nezam/core/memory/`.
...
- Pairs with `@.cursor/skills/nezam-ia-taxonomy/SKILL.md`, `@.cursor/skills/nezam-geo-optimization/SKILL.md`, `@.cursor/skills/nezam-serp-feature-targeting/SKILL.md`.
