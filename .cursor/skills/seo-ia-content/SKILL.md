...
- Brand voice + glossary from `docs/prompts/PROJECT_PROMPT.md`.
...
2. Author `docs/specs/sdd/SEO_RESEARCH.md`: business + audience summary, competitor matrix, clusters, snippet/FAQ opportunities, GEO/AEO cues, localized entities.
3. Translate clusters into IA in `docs/specs/sdd/IA_CONTENT.md`: nav map, route hierarchy, accessible long-form labels, internal-link plan.
...
- `docs/specs/sdd/SEO_RESEARCH.md` (clusters, opportunities, GEO/AEO cues).
- `docs/specs/sdd/IA_CONTENT.md` (nav, routes, headings, links).
...
- Instructor-oriented domain routing (teaching, not execution): [`docs/reference/skills/guide_instructor_domains/skill.md`](../../../docs/reference/skills/guide_instructor_domains/skill.md). Use for pedagogy patterns only; **this** skill owns COIA SEO/IA artifact paths (`docs/specs/sdd/`, PRD).
