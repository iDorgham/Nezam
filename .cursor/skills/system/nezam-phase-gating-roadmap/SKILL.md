---
skill_id: nezam-phase-gating-roadmap
name: "nezam-Phase Gating Roadmap"
tier: 3
...
- `.nezam/core/plans/INDEX.md` traceability matrix.
...
7. Update `.nezam/core/plans/INDEX.md` with phase status; surface next legal `/COMMAND`.
...
- `.nezam/core/plans/INDEX.md` status update (markdown table).
...
- Pairs with `@.cursor/skills/nezam-strategic-planning/SKILL.md` upstream and `@.cursor/skills/nezam-task-decomposition/SKILL.md` downstream.
- Enforces `[.cursor/rules/nezam-design-gates-pro.mdc](.cursor/rules/nezam-design-gates-pro.mdc)` Gates 1–7.
