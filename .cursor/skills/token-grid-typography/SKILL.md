...
- `DESIGN.md` typography, spacing, and layout sections.
- `docs/specs/sdd/SEO_RESEARCH.md` and IA constraints when available.
...
1. Extract design primitives from `DESIGN.md` into categories: color, spacing, radius, typography, shadow, z-index, motion.
...
- `docs/specs/sdd/TYPOGRAPHY_GRID_MATRIX.md` (reference table).
