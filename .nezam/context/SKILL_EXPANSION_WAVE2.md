...
3. **All new skills require frontmatter** from `.nezam/templates/skills/SKILL_NEZAM_CANONICAL.template.md`: `skill_id`, `name`, `description`, `version`, `updated`, `changelog`, `owner`, `tier`, `sdd_phase`, `rtl_aware`, `certified`, `dependencies`
