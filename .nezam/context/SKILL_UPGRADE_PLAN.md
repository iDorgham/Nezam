...
> Source analysis: `.nezam/workspace/RF/skills/` × `.cursor/skills/` × superdesign methodology  
...
|--------|------|-------|----------------|
| B | Design methodology improvements | 7 items (2 new, 5 upgrades) | `.nezam/workspace/RF/skills/superdesign/` |
| A1 | RF vendor skill upgrades | 7 upgrades to existing skills | `.nezam/workspace/RF/skills/official_*/` |
| A2 | RF net-new skills | 10 new skills | `.nezam/workspace/RF/skills/official_*/` |
...
**Source:** `.nezam/workspace/RF/skills/superdesign/INIT.md`  
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ pixel-perfect reproduction, context file discipline  
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ pixel-perfect reproduction step, design-system.md fidelity  
**SDD Phase:** design
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ branch mode, variation count  
**SDD Phase:** design
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ Petite-Vue component extraction template  
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ Step 3a + 3b workflow  
**SDD Phase:** design
...
**Source:** `.nezam/workspace/RF/skills/superdesign/SUPERDESIGN.md` §§ design-system.md as hard constraint, drift prevention  
**SDD Phase:** design
...
**RF Source:** `.nezam/workspace/RF/skills/official_prisma/skill.md`  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_resend/skill.md`  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_vercel/skill.md` (use_ai_sdk variant)  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_github/` (security_review + threat_model variants)  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_github/` (security_review + threat_model_analyst)  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_vercel/` (adr_skill variant — "ADR as executable spec")  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_vercel/` + `official_firebase/`  
**Key additions:**
...
**RF Source:** `.nezam/workspace/RF/skills/official_firebase/skill.md`  
...
**RF Source:** `.nezam/workspace/RF/skills/official_firebase/` (security_rules_auditor variant)  
...
**RF Source:** `.nezam/workspace/RF/skills/official_firecrawl/skill.md`  
**SDD Phase:** development  
**Tier:** 3
...
**RF Source:** `.nezam/workspace/RF/skills/official_browserbase/skill.md`  
...
**RF Source:** `.nezam/workspace/RF/skills/official_apify/skill.md`  
**SDD Phase:** development  
**Tier:** 3
...
**RF Source:** `.nezam/workspace/RF/skills/official_google_gemini/skill.md`  
**SDD Phase:** development  
**Tier:** 2
...
**RF Source:** `.nezam/workspace/RF/skills/official_vercel/` (adr_skill variant)  
**SDD Phase:** planning  
**Tier:** 1
...
**RF Source:** `.nezam/workspace/RF/skills/official_wordpress/skill.md`  
**SDD Phase:** development  
**Tier:** 3
...
- **All new skills use the NEZAM canonical template** from `.nezam/templates/skills/SKILL_NEZAM_CANONICAL.template.md`.
