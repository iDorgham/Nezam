...
| -- | ------- | ------------- |
| B1 | No `.nezam/workspace/prd/features/<id>/SPEC.md` files yet — only [`.nezam/workspace/prd/features/README.md`](../../../../.cursor/agents/README.md) | First feature epic scoped + SPEC written |
...
| B3 | [`.nezam/workspace/prd/sdd/SEO_RESEARCH.md`](.nezam/workspace/prd/sdd/SEO_RESEARCH.md) missing | `/CREATE seo` or authored research doc |
| B4 | [`.nezam/workspace/prd/sdd/ROADMAP.md`](.nezam/workspace/prd/sdd/ROADMAP.md) missing | Roadmap slice authored under SDD |
...
1. **Source:** [`.nezam/workspace/prd/PRD.md`](.nezam/workspace/prd/PRD.md) requirement R1; [`scripts/checks/check-onboarding-readiness.sh`](scripts/checks/check-onboarding-readiness.sh).
2. **Test type:** Integration (shell / CI).
3. **Acceptance:** Script exits 0 when PRD and `.nezam/workspace/prd/PROJECT_PROMPT.md` exist.
...
1. **Source:** [`.nezam/core/memory/CONTEXT.md`](.nezam/core/memory/CONTEXT.md).
...
1. **Source:** [`.nezam/core/plans/INDEX.md`](.nezam/core/plans/INDEX.md); [`.nezam/core/plans/MASTER_TASKS.md`](.nezam/core/plans/MASTER_TASKS.md).
...
1. **Source:** [`.nezam/workspace/prd/prd/PRD.md`](.nezam/workspace/prd/prd/PRD.md) R2.
2. **Test type:** Manual audit.
3. **Acceptance:** `.nezam/core/plans/INDEX.md` lists MT/PT rows with gate IDs; phase TASKS files exist under `.nezam/core/plans/*/TASKS.md`.
4. **Mocking:** None.
