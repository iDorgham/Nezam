...
usage() {
  ...
  echo ""
  echo "  <brand> is a folder name under .nezam/design-hub/design/ (each folder contains design.md)."
  echo "  Copies:  .nezam/design-hub/design/<brand>/design.md  →  DESIGN.md (repository root)"
  echo ""
  echo "Examples:"
  ...
  echo ""
  echo "First folders under .nezam/design-hub/design/:"
  ls "$ROOT/.nezam/design-hub/design" 2>/dev/null | head -30 || true
}
...
SRC="$ROOT/.nezam/design-hub/design/$BRAND/design.md"
if [[ ! -f "$SRC" ]]; then
