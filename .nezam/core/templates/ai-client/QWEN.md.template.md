...
- **Catalog:** `.nezam/design-hub/design/<brand>/design.md` — **contract:** repository root **`DESIGN.md`**
- **Shell:** `pnpm run design:apply -- <brand>`
- **Cross-client map:** [`.nezam/core/memory/MULTI_TOOL_INDEX.md`](.nezam/core/memory/MULTI_TOOL_INDEX.md) — after `.cursor/` edits run `pnpm ai:sync` then `pnpm ai:check`
