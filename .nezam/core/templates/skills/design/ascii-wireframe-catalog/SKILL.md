...
- `@.nezam/core/templates/design/wireframe-base/SKILL.md`
...
└── ...
.nezam/core/memory/design-wireframes/
...
- `@.nezam/core/templates/skills/design/design-md/SKILL.md`
- `@.cursor/rules/design-dev-gates.mdc`

## SDD Alignment
- Phase: `PLAN → DESIGN`
- Gate: `design_contract`
- Memory: `.nezam/core/memory/design-wireframes/`
