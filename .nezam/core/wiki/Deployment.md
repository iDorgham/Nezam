...
| Check onboarding | `.nezam/scripts/checks/check-onboarding-readiness.sh` | Validate workspace setup |
| Check tokens | `.nezam/scripts/checks/check-design-tokens.sh` | Validate design tokens |
