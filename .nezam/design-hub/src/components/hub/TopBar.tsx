...
import { Undo2, Redo2, Sparkles, Bookmark, Check } from 'lucide-react'
import { useHub } from '@/store/hub.store'
import { IconButton } from '@/components/ui/IconButton'
import { ExportMenu } from './ExportMenu'
import { cn } from '@/lib/cn'

/** The application's top chrome: identity, history, AI, save, export. */
  ...
  return (
    <header className="flex h-[52px] shrink-0 items-center gap-3 border-b border-app-border bg-app-surface px-3">
      ...
      <button
        onClick={surpriseMe}
        className={cn(
          'focus-ring group flex h-8 items-center gap-1.5 rounded-app-sm px-3 text-xs font-semibold',
