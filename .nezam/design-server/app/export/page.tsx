  ...
  return (
    <div className="p-4 w-full space-y-6">
      <div>
        ...
        <p className="text-ds-text-muted text-xs mt-0.5">Finalize your design decisions and generate the SDD contract.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-3 bg-[#0f1011] border border-[#ffffff14] rounded space-y-3">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between">
              <span className="text-ds-text-muted">Pages Defined:</span>
              <span className="text-white font-medium">{sitemap.length}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-ds-text-muted">Theme Profile:</span>
              <span className="text-white font-medium">{templateConfig.colorProfile || 'Not selected'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-ds-text-muted">Typography:</span>
        ...
        <div className="p-3 bg-[#0f1011] border border-[#ffffff14] rounded flex flex-col justify-between">
          <div>
            ...
            <p className="text-[10px] text-ds-text-muted">Exporting will lock these settings and notify the NEZAM swarm agents to begin development.</p>
          </div>
          <button
