...
- **Design references tree:** `~/nezam-references/` holds design reference materials (outside the workspace). Run `scripts/setup/fetch-references.sh` to download on demand.
