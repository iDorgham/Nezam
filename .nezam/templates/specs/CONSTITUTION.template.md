...
Non-negotiable principles for architecture, quality, and security. Amend via dated decision in `.nezam/core/memory/MEMORY.md` and linked spec appendix.
...
1. Propose change in a spec or `.nezam/core/memory/MEMORY.md` with date and rationale.
