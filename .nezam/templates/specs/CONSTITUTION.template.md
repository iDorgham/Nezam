...
Non-negotiable principles for architecture, quality, and security. Amend via dated decision in `.nezam/memory/MEMORY.md` and linked spec appendix.
...
1. Propose change in a spec or `.nezam/memory/MEMORY.md` with date and rationale.
