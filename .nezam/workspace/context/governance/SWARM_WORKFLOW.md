...
Refer to `.nezam/workspace/context/PHASE_HANDOFF.md` for the required structure.

---
> [!NOTE]
> All decisions must be logged in `.nezam/workspace/decisions/SWARM_DECISION_LOG.md`.
