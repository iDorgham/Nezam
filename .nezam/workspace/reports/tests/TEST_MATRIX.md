...
| -- | ------- | ------------- |
| B1 | No `.nezam/workspace/prd/features/<id>/SPEC.md` files yet — only [`.nezam/workspace/prd/features/README.md`](.nezam/workspace/prd/features/README.md) | First feature epic scoped + SPEC written |
