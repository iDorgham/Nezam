# COIA Master Refactor — Cursor Prompt
...
rm -f COIA_WEAKNESS_FIX_PROMPT.md
rm -f COIA_NONDEVELOPER_DAILY_GUIDE.md
...
.cursor/skills/
  system/                     # Core workspace system skills
    ...
    skill-composer/           # (was coi-skill-composer)
    task-decomposition/       # (was coi-task-decomposition)
    multi-agent-handoff/      # (was coi-multi-agent-handoff)
    docs-context-sync/        # (was coi-docs-context-sync)
    phase-gating-roadmap/     # (was coi-phase-gating-roadmap)
    health-score/             # (was coi-health-score)
    decision-journal/         # (was coi-decision-journal)
    strategic-planning/       # (was coi-strategic-planning)
    repo-file-org/            # (was coi-repo-file-org)
    founder-onboarding/       # (was coi-founder-onboarding)
    risk-mitigation/          # (was coi-risk-mitigation)

  research/                   # SEO, AEO, audience, competitive
    seo-ia-content/           # (was seo-ia-content)
    serp-feature-targeting/   # (was coi-serp-feature-targeting)
    topical-authority/        # (was coi-topical-authority)
    aeo-answer-engines/       # (was coi-aeo-answer-engines)
    ia-taxonomy/              # (was coi-ia-taxonomy)
    geo-optimization/         # (was coi-geo-optimization)
    structured-data-schema/   # (was coi-structured-data-schema)

  design/                     # Design system, tokens, motion, UI
    design-tokens/            # (was coi-pro-design-tokens)
    token-grid-typography/    # (was token-grid-typography)
    brand-visual-direction/   # (was brand-visual-direction)
    ui-ux-design/             # (was coi-ui-ux-design)
    frontend-design-pro/      # (was coi-frontend-design-pro)
    component-library-api/    # (was coi-component-library-api)
    motion-3d/                # (was coi-motion-3d-progressive)
    ...
    dashboard-patterns/       # (was coi-dashboard-patterns)

  content/                    # Content creation, editorial, Arabic
    editorial-workflows/      # (was coi-editorial-workflows)
    content-modeling/         # (was coi-content-modeling)
  ...
  frontend/                   # React, Next.js, component implementation
    react-architecture/       # (was coi-react-architecture)

  backend/                    # API, DB, auth, integrations
    api-design/               # (was coi-api-design)
    api-gateway/              # (was coi-api-gateway)
    auth-workflows/           # (was coi-auth-workflows)
    supabase-architect/       # (was coi-supabase-architect)
    prisma-orm/               # (was coi-prisma-orm)
    database-optimization/    # (was coi-database-optimization)
    cache-strategies/         # (was coi-cache-strategies)
    cms-integration/          # (was coi-cms-integration)
    mena-payment-routing/     # (was mena_payment_routing — fix snake_case)

  infrastructure/             # DevOps, cloud, CDN, monitoring
    devops-pipeline/          # (was coi-devops-pipeline)
    vercel-deploy/            # (was coi-vercel-deploy)
    aws-infra/                # (was coi-aws-infra)
    cdn-optimization/         # (was coi-cdn-optimization)
    cloudflare-edge/          # (was coi-cloudflare-edge)
    monitoring-observability/ # (was coi-monitoring-observability)
    error-tracking/           # (was coi-error-tracking)
    secret-management/        # (was coi-secret-management)

  quality/                    # Security, testing, performance, a11y
    security-hardening/       # (was coi-security-hardening)
    gh-security-compliance/   # (was coi-gh-security-compliance)
    github-actions-ci/        # (was coi-github-actions-ci)
    privacy-compliance/       # (was coi-privacy-compliance)
    testing-automation/       # (was coi-testing-automation)
    testing-strategy/         # (was coi-testing-strategy)
    performance-optimization/ # (was coi-performance-optimization)
    a11y-automation/          # (was coi-a11y-automation)
    scan-fix-loop/            # (was coi-scan-fix-loop)
...
# --- SYSTEM ---
mkdir -p system
mv coi-skill-composer system/skill-composer
mv coi-task-decomposition system/task-decomposition
mv coi-multi-agent-handoff system/multi-agent-handoff
mv coi-docs-context-sync system/docs-context-sync
mv coi-phase-gating-roadmap system/phase-gating-roadmap
mv coi-health-score system/health-score
mv coi-decision-journal system/decision-journal
mv coi-strategic-planning system/strategic-planning
mv coi-repo-file-org system/repo-file-org
mv coi-founder-onboarding system/founder-onboarding
mv coi-risk-mitigation system/risk-mitigation
...
mv coi-serp-feature-targeting research/serp-feature-targeting
mv coi-topical-authority research/topical-authority
mv coi-aeo-answer-engines research/aeo-answer-engines
mv coi-ia-taxonomy research/ia-taxonomy
mv coi-geo-optimization research/geo-optimization
mv coi-structured-data-schema research/structured-data-schema

# --- DESIGN ---
mkdir -p design
mv coi-pro-design-tokens design/design-tokens
mv token-grid-typography design/token-grid-typography
mv brand-visual-direction design/brand-visual-direction
mv coi-ui-ux-design design/ui-ux-design
mv coi-frontend-design-pro design/frontend-design-pro
mv coi-component-library-api design/component-library-api
mv coi-motion-3d-progressive design/motion-3d
mv css-architecture-runtime design/css-architecture
mv design-md design/design-md
mv coi-dashboard-patterns design/dashboard-patterns
...
# --- CONTENT ---
mkdir -p content
mv coi-editorial-workflows content/editorial-workflows
mv coi-content-modeling content/content-modeling
mv arabic_content_master content/arabic-content
mv egyptian_arabic_content_master content/egyptian-arabic-content

# --- FRONTEND ---
mkdir -p frontend
mv coi-react-architecture frontend/react-architecture

# --- BACKEND ---
mkdir -p backend
mv coi-api-design backend/api-design
mv coi-api-gateway backend/api-gateway
mv coi-auth-workflows backend/auth-workflows
mv coi-supabase-architect backend/supabase-architect
mv coi-prisma-orm backend/prisma-orm
mv coi-database-optimization backend/database-optimization
mv coi-cache-strategies backend/cache-strategies
mv coi-cms-integration backend/cms-integration
mv mena_payment_routing backend/mena-payment-routing

# --- INFRASTRUCTURE ---
mkdir -p infrastructure
mv coi-devops-pipeline infrastructure/devops-pipeline
mv coi-vercel-deploy infrastructure/vercel-deploy
mv coi-aws-infra infrastructure/aws-infra
mv coi-cdn-optimization infrastructure/cdn-optimization
mv coi-cloudflare-edge infrastructure/cloudflare-edge
mv coi-monitoring-observability infrastructure/monitoring-observability
mv coi-error-tracking infrastructure/error-tracking
mv coi-secret-management infrastructure/secret-management

# --- QUALITY ---
mkdir -p quality
mv coi-security-hardening quality/security-hardening
mv coi-gh-security-compliance quality/gh-security-compliance
mv coi-github-actions-ci quality/github-actions-ci
mv coi-privacy-compliance quality/privacy-compliance
mv coi-testing-automation quality/testing-automation
mv coi-testing-strategy quality/testing-strategy
mv coi-performance-optimization quality/performance-optimization
mv coi-a11y-automation quality/a11y-automation
mv coi-scan-fix-loop quality/scan-fix-loop
...
```bash
find .cursor/skills -name "SKILL.md" -exec sed -i 's/coi-skill-composer/system\/skill-composer/g' {} \;
