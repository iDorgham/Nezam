# NEZAM Agent Evaluation Suite (`docs/evals/`)
...
1. Open agent eval YAML: `docs/evals/cases/<agent>.eval.yaml`
...
4. Write results to `docs/evals/results/EVAL_RESULTS.md`.
...
4. Record resolution in `docs/evals/certification/CERT_LOG.md`.

---

## Adding New Eval Cases

1. Create `docs/evals/cases/<agent-name>.eval.yaml`.
