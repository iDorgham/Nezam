...
- `docs/nezam/` contains NEZAM's own governance (do not touch)
...
- `.cursor/workspace.paths.yaml` — canonical path config

**Do NOT modify:** `docs/nezam/`, `.cursor/agents/`, `.cursor/skills/`, `.cursor/rules/agent-lazy-load.mdc`
