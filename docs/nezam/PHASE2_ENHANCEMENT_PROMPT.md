...
**Do NOT touch:** `docs/nezam/`, `.cursor/design/` profiles, any file under `.cursor/skills/backend/`,
...
- Any file inside `.cursor/design/` (100+ design profiles — do not touch)
...
- `docs/nezam/` — workspace governance docs — read only
