...
- Restructured `docs/` so `docs/nezam/` is governance and `docs/prd|plans|reports/` is user project
...
**Do NOT touch:**
- `.cursor/design/` — all 150+ design profiles, catalog.json, README.md
- `docs/nezam/` — workspace governance docs (read-only from user projects)
...
> The canonical PRD path is `docs/prd/PRD.md` (configurable via `.cursor/workspace.paths.yaml`).
...
`docs/nezam/VERSIONING.md` (governance file, not user project file).
...
- PRD artifact at `docs/prd/PRD.md` (or path from `.cursor/workspace.paths.yaml`).
```
...
### 2D. Create VERSIONING.md in docs/nezam/

**File:** `docs/nezam/VERSIONING.md`
...
1. Check `docs/nezam/CHANGELOG.md` for breaking changes
...
See `docs/nezam/CHANGELOG.md`.
```

### 2E. Create docs/nezam/CHANGELOG.md

**File:** `docs/nezam/CHANGELOG.md`
**Action:** Create this file.
...
- `docs/nezam/` created as governance layer
- `docs/prd/`, `docs/plans/`, `docs/reports/` as clean user project scaffold
- 150+ design profiles in `.cursor/design/`
...
Create one getting-started file per Tier 1 tool. These go in `docs/nezam/tools/`.

**File:** `docs/nezam/tools/CLAUDE_CODE.md`
**Action:** Create this file.
...
**File:** `docs/nezam/tools/ANTIGRAVITY.md`
**Action:** Create this file.
...
**File:** `docs/nezam/tools/CODEX.md`
**Action:** Create this file.
...
**File:** `docs/nezam/tools/CURSOR.md`
**Action:** Create this file.
...
`.cursor/design/` contains 150+ design profiles.
...
| 6 | Create docs/nezam/VERSIONING.md | `docs/nezam/VERSIONING.md` | File exists with semver policy |
| 7 | Create docs/nezam/CHANGELOG.md | `docs/nezam/CHANGELOG.md` | File exists with v3.0.0 entry |
...
| 13 | Create 4 tool GETTING_STARTED files | `docs/nezam/tools/*.md` | 4 files exist |
...
- [ ] `docs/nezam/CHANGELOG.md` exists with v3.0.0 entry
- [ ] `docs/nezam/VERSIONING.md` exists with SemVer policy
...
- [ ] 4 tool files exist in `docs/nezam/tools/`
...
- `.cursor/design/` — all design profiles and catalog.json
...
- Any files inside `docs/nezam/` EXCEPT creating new files (VERSIONING.md, CHANGELOG.md, tools/)
