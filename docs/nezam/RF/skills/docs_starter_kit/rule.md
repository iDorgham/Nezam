...
- `docs/API.md` (API reference path in generated project)
- `docs/ARCHITECTURE.md` (architecture path in generated project)
- `CONTRIBUTING.md` (contributing guide path in generated project)
