...
- **JavaScript/TypeScript**: See js_ts_actorization.md (`references/js_ts_actorization.md`)
- **Python**: See python_actorization.md (`references/python_actorization.md`)
- **Other Languages (CLI-based)**: See cli_actorization.md (`references/cli_actorization.md`)
...
See schemas_and_output.md (`references/schemas_and_output.md`) for detailed configuration of:
