...
See references/service_hooks.md (`references/service_hooks.md`) for implementation patterns.
...
For implementation patterns and code examples, see references/service_hooks.md (`references/service_hooks.md`):
...
- references/service_hooks.md (`references/service_hooks.md`) - Detailed service hook implementations
- references/existing_plugins.md (`references/existing_plugins.md`) - Index of existing plugins
