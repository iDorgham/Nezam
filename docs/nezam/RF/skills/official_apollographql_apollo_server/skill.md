...
- Context and Auth (`references/context_and_auth.md`) - Authentication and authorization
- Plugins (`references/plugins.md`) - Server and request lifecycle hooks
- Data Sources (`references/data_sources.md`) - RESTDataSource and DataLoader
- Error Handling (`references/error_handling.md`) - GraphQLError and error formatting
