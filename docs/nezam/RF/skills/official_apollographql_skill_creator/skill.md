...
- Topic A (`references/topic_a.md`) - Detailed guide for topic A
- Topic B (`references/topic_b.md`) - Detailed guide for topic B
...
- Apollo Skills (`references/apollo_skills.md`) - Patterns and examples for Apollo GraphQL skills
