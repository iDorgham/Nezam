...
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md#execution-modes-executionconfig`)** for detailed configuration examples per mode.
...
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md#profileconfig-warehouse-connection`)** for detailed ProfileConfig options and all ProfileMapping classes.
...
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md#testing-behavior-renderconfig`)** for detailed testing options.
...
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md#operator_args-configuration`)** for detailed operator_args options.
