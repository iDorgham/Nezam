...
For detailed examples and patterns, see `references/server_side_rendering.md`.
...
For quick directive reminders, see `references/directives_quickref.md`.
...
- Consult:
  - `references/server_side_rendering.md`
  - `references/directives_quickref.md`
