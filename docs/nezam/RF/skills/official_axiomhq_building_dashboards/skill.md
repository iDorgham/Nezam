...
See `reference/metrics_mpl.md` for the full contract and discovery scripts.
...
Charts support JSON configuration options beyond the query. See `reference/chart_config.md` for full details.
...
**spl-to-apl:** Translate Splunk SPL → APL. Map `timechart` → TimeSeries, `stats` → Statistic/Table. See `reference/splunk_migration.md`.
...
- `reference/chart_config.md` — All chart configuration options (JSON)
- `reference/metrics_mpl.md` — Metrics/MPL chart contract and discovery scripts
- `reference/smartfilter.md` — SmartFilter/FilterBar full configuration
- `reference/chart_cookbook.md` — APL patterns per chart type
- `reference/layout_recipes.md` — Grid layouts and section blueprints
- `reference/splunk_migration.md` — Splunk panel → Axiom mapping
- `reference/design_playbook.md` — Decision-first design principles
