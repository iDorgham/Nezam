...
Creates dashboard with: ingest trends, burn rate, projections, waste candidates, top users. See `reference/dashboard_panels.md` for details.
...
See `reference/monitor_strategy.md` for threshold derivation.
...
All P0⛔ and P1 datasets analyzed. Then compile report using `reference/analysis_report_template.md`.
