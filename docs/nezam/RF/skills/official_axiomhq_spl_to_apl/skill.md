...
Complete mappings: `reference/command_mapping.md`
...
Complete function list: `reference/function_mapping.md`
...
- `reference/command_mapping.md` — complete command list
- `reference/function_mapping.md` — complete function list  
