...
- Transcription Options (`references/transcription_options.md`)
- Real-Time Client-Side Streaming (`references/realtime_client_side.md`)
- Real-Time Server-Side Streaming (`references/realtime_server_side.md`)
- Commit Strategies (`references/realtime_commit_strategies.md`)
- Real-Time Event Reference (`references/realtime_events.md`)
