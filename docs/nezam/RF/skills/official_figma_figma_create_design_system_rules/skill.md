...
| Codex CLI | `AGENTS.md` |
| Cursor | `.cursor/rules/figma_design_system.mdc` |
...
|-------|-----------|-------|
| Claude Code | `CLAUDE.md` in project root | Markdown format. Can also use `.claude/rules/figma_design_system.md` for modular organization. |
...
| Cursor | `.cursor/rules/figma_design_system.mdc` | Markdown with YAML frontmatter (`description`, `globs`, `alwaysApply`). |
