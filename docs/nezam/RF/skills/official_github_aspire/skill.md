...
|---|---|
| CLI Reference (`references/cli_reference.md`) | Command flags, options, or detailed usage |
| MCP Server (`references/mcp_server.md`) | Setting up MCP for AI assistants, available tools |
| Integrations Catalog (`references/integrations_catalog.md`) | Discovering integrations via MCP tools, wiring patterns |
| Polyglot APIs (`references/polyglot_apis.md`) | Method signatures, chaining options, language-specific patterns |
...
The Aspire team ships an **MCP server** that provides documentation tools directly inside your AI assistant. See MCP Server (`references/mcp_server.md`) for setup details.
...
For complete API signatures, see Polyglot APIs (`references/polyglot_apis.md`).
...
Full command reference with flags: CLI Reference (`references/cli_reference.md`).
