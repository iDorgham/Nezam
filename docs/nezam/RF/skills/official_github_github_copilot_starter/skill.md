...
### 1. `.github/copilot_instructions.md`
...
Apply the repository-wide guidance from `../copilot_instructions.md` to all code.
...
4. **Generate main copilot_instructions.md** with project-wide standards
