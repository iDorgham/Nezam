...
- **`references/single_context.md`** - complete migration for one context (theme, auth, etc.) with provider + class consumer + function consumer
- **`references/multi_context.md`** - apps with multiple legacy contexts (nested providers, multiple consumers of different contexts)
- **`references/context_file_template.md`** - the standard file structure for a new context module
