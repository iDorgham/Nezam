...
- **`references/react18_scans.md`** - all scans for React 16/17 → 18.3.1 audit
- **`references/react19_scans.md`** - all scans for React 18 → 19 audit
- **`references/test_scans.md`** - test file specific scans (used by both auditors)
- **`references/dep_scans.md`** - dependency and peer conflict scans
