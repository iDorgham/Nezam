...
2. Fetch specific pages (e.g., `https://ai.google.dev/gemini-api/docs/live_session.md.txt`)
...
- [Live API Capabilities Guide](https://ai.google.dev/gemini-api/docs/live_guide.md.txt) — voice config, transcription config, native audio (thinking), VAD configuration, media resolution
- [Live API Tool Use](https://ai.google.dev/gemini-api/docs/live_tools.md.txt) — function calling (sync and async), Google Search grounding
- [Session Management](https://ai.google.dev/gemini-api/docs/live_session.md.txt) — context window compression, session resumption, GoAway signals
- [Ephemeral Tokens](https://ai.google.dev/gemini-api/docs/ephemeral_tokens.md.txt) — secure client-side authentication for browser/mobile
