...
| `dagger.*`, `dagger.hilt.*` | DAGGER_HILT.md (`references/frameworks/DAGGER_HILT.md`) |
...
Apply the conversion methodology from CONVERSION_METHODOLOGY.md (`references/CONVERSION_METHODOLOGY.md`).
...
See KNOWN_ISSUES.md (`references/KNOWN_ISSUES.md`) for:
