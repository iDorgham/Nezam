...
- **references/design_patterns.md (`references/design_patterns.md`)** - Iterative style development, environment-specific tokens, validation-first development, documentation-driven development, tool integration patterns
