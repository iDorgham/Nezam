...
- **Framework Hooks** → Load `references/framework_hooks.md`
  - When: Building custom hooks (React) or composables (Vue) around Search JS Core
- **Testing and Monitoring** → Load `references/testing_monitoring.md`
