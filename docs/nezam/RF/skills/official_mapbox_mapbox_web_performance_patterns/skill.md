...
- **`references/data_loading.md`** — GeoJSON vs Vector Tiles decision matrix, viewport-based loading, progressive loading, vector tiles for large datasets
...
- **`references/layers_styles.md`** — Consolidate layers with data-driven styling, simplify expressions, zoom-based visibility
