...
6. Destructive actions require `ask_user` — global-rules (`references/services/functions/global_rules.md`)

## Migration Scenarios

| Source | Target | Reference |
|--------|--------|-----------|
| AWS Lambda | Azure Functions | lambda_to_functions.md (`references/services/functions/lambda_to_functions.md`) (assessment (`references/services/functions/assessment.md`), code-migration (`references/services/functions/code_migration.md`)) |
| GCP Cloud Run | Azure Container Apps | cloudrun_to_container_apps.md (`references/services/container-apps/cloudrun_to_container_apps.md`) |
...
Track progress in `migration_status.md` — see workflow_details.md (`references/workflow_details.md`).
