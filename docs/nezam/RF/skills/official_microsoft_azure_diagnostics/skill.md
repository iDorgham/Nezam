...
| **AKS** | Cluster access, nodes, `kube-system`, scheduling, crash loops, ingress, DNS, upgrades | AKS Troubleshooting (`aks-troubleshooting/aks_troubleshooting.md`) |
...
- Route active AKS incidents, AKS-specific intake, evidence gathering, and remediation guidance to AKS Troubleshooting (`aks-troubleshooting/aks_troubleshooting.md`).
...
See kql_queries.md (`references/kql_queries.md`) for common diagnostic queries.
...
- KQL Query Library (`references/kql_queries.md`)
- Azure Resource Graph Queries (`references/azure_resource_graph.md`)
