...
| Output schema | plan_schema.md (`references/plan_schema.md`) |
| Key references | research.md (`references/research.md`), resources/ (`references/resources/README.md`), waf_checklist.md (`references/waf_checklist.md`), constraints/ (`references/constraints/README.md`) |
