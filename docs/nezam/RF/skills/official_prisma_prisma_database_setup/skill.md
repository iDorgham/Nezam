...
references/prisma_postgres.md
references/prisma_client_setup.md
```

## How to Use

Choose the provider reference file for your database, then apply `references/prisma_client_setup.md` to complete client generation and adapter setup. For MongoDB, use `references/mongodb.md` instead of copying the SQL adapter examples or Prisma 7 config pattern.
