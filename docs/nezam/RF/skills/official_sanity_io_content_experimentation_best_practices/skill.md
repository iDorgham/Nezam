...
- `references/experiment_design.md` — Hypothesis framework, metrics, sample size, and what to test
- `references/statistical_foundations.md` — p-values, confidence intervals, power analysis, Bayesian methods
- `references/cms_integration.md` — CMS-managed variants, field-level variants, external platforms
- `references/common_pitfalls.md` — 17 common mistakes across statistics, design, execution, and interpretation
