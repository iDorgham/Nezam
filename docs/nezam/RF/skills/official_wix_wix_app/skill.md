...
3. **Check relevant API reference files:**
   - Backend events → `references/backend-event/COMMON_EVENTS.md`
...
| "Listen for cart events"             | Check `COMMON_EVENTS.md`             | MCP discovery only if event missing in reference    |
