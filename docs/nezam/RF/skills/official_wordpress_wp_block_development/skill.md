...
Read:
- `references/creating_new_blocks.md`
...
Read:
- `references/block_json.md` (apiVersion and schema details)
...
Read:
- `references/supports_and_wrappers.md`
- `references/dynamic_rendering.md` (if dynamic)
...
Read:
- `references/attributes_and_serialization.md`
...
Read:
- `references/tooling_and_testing.md`
...
- `references/attributes_and_serialization.md` (attributes not saving)
