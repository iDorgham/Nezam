...
3. **Create RULE.md**: Main skill file with frontmatter and content
...
```
skill-name/
├── RULE.md              # Main skill file (required)
...
touch "backend/api-rate-limiter/RULE.md"
```

### Step 3: Write RULE.md
...
- [ ] Placed in correct category folder
- [ ] RULE.md follows template structure
