...
### B10 — [FIX] Archive/migrate `docs/nezam/RF/` skills directory

`docs/nezam/RF/skills/` is a disconnected vendor reference tree never loaded by any agent.

1. Create `docs/nezam/archive/RF-2026-05-12/`
2. Move `docs/nezam/RF/skills/` to `docs/nezam/archive/RF-2026-05-12/skills/`
3. Create `docs/nezam/archive/RF-2026-05-12/README.md`:
   ```markdown
   ...
   ```
4. If `docs/nezam/RF/` is now empty (or contains only the `skills/` dir), remove it.
...
- [ ] `docs/nezam/RF/skills/` moved to `docs/nezam/archive/RF-2026-05-12/`
