...
> All 24 changes follow the canonical template at `.cursor/templates/skills/SKILL_NEZAM_CANONICAL.template.md`.
...
This is a brand-new NEZAM skill. Use the canonical template format found at `.cursor/templates/skills/SKILL_NEZAM_CANONICAL.template.md` as the structural base.
...
Use the canonical template at `.cursor/templates/skills/SKILL_NEZAM_CANONICAL.template.md` as the structural base.
