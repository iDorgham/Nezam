...
- **Long-term Memory (Durable)**: Stored in `docs/nezam/memory/MEMORY.md` and related files. Retained indefinitely until explicitly archived.
...
- **Read**: `docs/nezam/memory/MEMORY.md`, `docs/prd/PRD.md`.
- **Write**: `docs/nezam/memory/MEMORY.md` (appends only), `docs/nezam/memory/PHASE_HANDOFF.md` (updates).
