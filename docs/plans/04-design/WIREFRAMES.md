...
> Full ASCII wireframes for every screen. Each maps to their screen ID.
...
# Part 2: Nightclub Reservation System Application (Wireframes)

> ASCII layouts representing the visual composition of target application views.
...
*Generated: 2026-05-18 | Source: DESIGN_CHOICES.md · IA_CONTENT.md · PRD v2.0.0 · new-planning merge*
