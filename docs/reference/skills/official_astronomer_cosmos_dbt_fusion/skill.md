...
>
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md`)** for ProfileConfig, operator_args, and Airflow 3 compatibility details.
...
> **Reference**: See **reference/cosmos_config.md (`reference/cosmos_config.md#profileconfig-warehouse-connection`)** for full ProfileConfig options and examples.
