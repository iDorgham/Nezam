...
For multi-level nested components or metadata prop passing between templates, see advanced_patterns.md (`references/advanced_patterns.md`).
...
If anything looks uncertain, consult api.md (`references/api.md`) for API details and advanced_patterns.md (`references/advanced_patterns.md`) for complex nesting.
...
- advanced_patterns.md (`references/advanced_patterns.md`) — Advanced nesting, metadata props, and descendant patterns
