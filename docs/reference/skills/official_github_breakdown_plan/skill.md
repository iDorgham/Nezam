...
1. **Project Plan**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/project_plan.md`
2. **Issue Creation Checklist**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/issues_checklist.md`
...
#### Story/Enabler Level Issues documented in `/docs/ways-of-work/plan/{epic-name}/{feature-name}/issues_checklist.md`
