...
For the complete command reference, see `references/pr_commands.md`.
...
- `references/dependabot_yml_reference.md` — Complete YAML options reference
- `references/pr_commands.md` — Full PR comment commands reference
- `references/example_configs.md` — Real-world configuration examples
