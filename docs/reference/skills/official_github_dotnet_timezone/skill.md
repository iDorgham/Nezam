...
2. Read `references/timezone_index.md` for common Windows and IANA mappings.
...
Use `references/timezone_index.md` for Windows to IANA mappings.
...
Use `references/code_patterns.md` and pick the smallest pattern that fits:
...
- `references/timezone_index.md`: common Windows and IANA timezone mappings
- `references/code_patterns.md`: ready-to-use .NET timezone patterns
