...
# See common_errors.md to decode the error code.
```
...
- common_errors.md (`references/common_errors.md`) — Error codes, likely causes, and fixes
- debug_workflow.md (`references/debug_workflow.md`) — Full decision tree for complex failures
