...
See references/issue_fields_api.md (`references/issue_fields_api.md`), references/projects_api.md (`references/projects_api.md`), and references/labels_api.md (`references/labels_api.md`) for full API details.
