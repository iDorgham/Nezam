...
When converting plain text into Unicode-styled LinkedIn text, first load and use `references/unicode_charmap.md` as the authoritative character mapping reference.
...
4. Apply Unicode bold/italic formatting to headers and emphasis words using `references/unicode_charmap.md`.
