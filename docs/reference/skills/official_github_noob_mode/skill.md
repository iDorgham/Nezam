...
```
📋 WHAT I'M ASKING TO DO:
I want to open and read the file "contracts/nda_template.md" so I can see what's in it.
...
📄 Files created:
  • ~/Desktop/IP_Analysis_Draft.md — Your IP analysis document
...
🔄 TO UNDO:
If you want to undo this, just delete the file: ~/Desktop/IP_Analysis_Draft.md
```
