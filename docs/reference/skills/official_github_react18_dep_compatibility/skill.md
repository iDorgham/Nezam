...
Read **`references/apollo_details.md`** for concurrent mode issues and MockedProvider changes.
...
**react-router v5 → v6 is a SEPARATE migration sprint.** Read `references/router_migration.md`.
