...
- **`references/enzyme_api_map.md`** - full mapping: shallow, mount, find, simulate, prop, state, instance, configure
- **`references/async_patterns.md`** - waitFor, findBy, act(), Apollo MockedProvider, loading states, error states
