...
> For detailed bypass and delegated bypass workflows, search `references/push_protection.md`.
...
> For detailed custom pattern configuration, search `references/custom_patterns.md`.
...
> For detailed alert types, validity checks, and REST API, search `references/alerts_and_remediation.md`.
...
- `references/push_protection.md` — Push protection mechanics, bypass workflow, delegated bypass, user push protection
  - Search patterns: `bypass`, `delegated`, `bypass request`, `command line`, `REST API`, `user push protection`
- `references/custom_patterns.md` — Custom pattern creation, regex syntax, dry runs, Copilot regex generation, scopes
  - Search patterns: `custom pattern`, `regex`, `dry run`, `publish`, `organization`, `enterprise`, `Copilot`
- `references/alerts_and_remediation.md` — Alert types, validity checks, extended metadata, generic alerts, secret removal, REST API
