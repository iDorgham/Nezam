...
2. Fetch specific pages (e.g., `https://ai.google.dev/gemini-api/docs/function_calling.md.txt`)

Key pages:
- [Text generation](https://ai.google.dev/gemini-api/docs/text_generation.md.txt)
- [Function calling](https://ai.google.dev/gemini-api/docs/function_calling.md.txt)
- [Structured outputs](https://ai.google.dev/gemini-api/docs/structured_output.md.txt)
- [Image generation](https://ai.google.dev/gemini-api/docs/image_generation.md.txt)
- [Image understanding](https://ai.google.dev/gemini-api/docs/image_understanding.md.txt)
