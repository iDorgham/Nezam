...
- `resources/setup_guide.md` - Step-by-step project initialization
- `resources/component_catalog.md` - Complete component reference
- `resources/customization_guide.md` - Theming and variant patterns
- `resources/migration_guide.md` - Upgrading from other UI libraries
