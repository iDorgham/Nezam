...
- **references/3d_extrusions.md (`references/3d_extrusions.md`)** — 3D building extrusions, custom data sources, data-driven heights
- **references/circles_lines.md (`references/circles_lines.md`)** — Circle/bubble maps, line data visualization, traffic flow styling
...
- **references/legends_use_cases.md (`references/legends_use_cases.md`)** — Legend UI, data inspector, data preprocessing, election/COVID/real-estate examples
