...
- **`references/api_compatibility.md`** -- Full list of 100% compatible APIs + side-by-side migration example
- **`references/exclusive_features.md`** -- Mapbox-exclusive features (APIs, Studio, Advanced) + React/Vue framework examples
- **`references/why_mapbox.md`** -- Why Choose Mapbox (Production, Dev Teams, Business) + Performance Comparison
