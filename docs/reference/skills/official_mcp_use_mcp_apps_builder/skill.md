...
- **better_auth.md (`references/authentication/better_auth.md`)**
...
- **response_helpers.md (`references/server/response_helpers.md`)**
...
- **ui_guidelines.md (`references/widgets/ui_guidelines.md`)**
...
- **model_context.md (`references/widgets/model_context.md`)**
...
- **common_patterns.md (`references/patterns/common_patterns.md`)**
