...
- **Content Safety**: Python (`references/sdk/azure_ai_contentsafety_py.md`) | TypeScript (`references/sdk/azure_ai_contentsafety_ts.md`)
- **API Management**: Python (`references/sdk/azure_mgmt_apimanagement_py.md`) | .NET (`references/sdk/azure_mgmt_apimanagement_dotnet.md`)
