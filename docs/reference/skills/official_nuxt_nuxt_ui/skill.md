...
- design-system (`references/guidelines/design_system.md`) — semantic colors, theming, brand customization, variants, the `ui` prop
- component-selection (`references/guidelines/component_selection.md`) — decision matrices: when to use Modal vs Slideover, Select vs SelectMenu, Toast vs Alert, etc.
...
- data-tables (`references/recipes/data_tables.md`) — tables with filters, pagination, sorting, selection
