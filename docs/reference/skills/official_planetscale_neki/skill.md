...
| --- | --- | --- |
| Sharding Readiness | [references/sharding_readiness.md](https://raw.githubusercontent.com/planetscale/database-skills/main/skills/neki/references/sharding_readiness.md) | Schema and query design practices that keep a Postgres database ready for future sharding |
