...
| Schema Changes | [references/schema_changes.md](https://raw.githubusercontent.com/planetscale/database-skills/main/skills/vitess/references/schema_changes.md) | Online DDL, managed migrations, ddl strategies, migration lifecycle |
...
| Query Serving | [references/query_serving.md](https://raw.githubusercontent.com/planetscale/database-skills/main/skills/vitess/references/query_serving.md) | Query routing, MySQL compatibility, cross-shard performance, EXPLAIN |
