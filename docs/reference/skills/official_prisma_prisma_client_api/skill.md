...
references/model_queries.md      - CRUD operations
references/query_options.md      - select, include, omit, where, orderBy
...
references/raw_queries.md        - $queryRaw, $executeRaw
references/client_methods.md     - $connect, $disconnect, $on, $extends
```
