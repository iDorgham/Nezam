...
Read `references/prisma7_client.md` for the full client instantiation reference.

## Error Handling

Read `references/api_basics.md` for the full error reference. Key self-correction patterns:
...
references/api_basics.md       — Base URL, envelope, IDs, errors, pagination
references/endpoints.md        — Endpoint details for projects, databases, connections, regions
references/prisma7_client.md   — Prisma 7 client instantiation and usage patterns
```
