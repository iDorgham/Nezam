...
| **Send batch emails** | sending/overview.md (`references/sending/overview.md`) → sending/batch_email_examples.md (`references/sending/batch_email_examples.md`) |
| **Full SDK examples** (Node.js, Python, Go, cURL) | sending/single_email_examples.md (`references/sending/single_email_examples.md`) |
| **Idempotency, retries, error handling** | sending/best_practices.md (`references/sending/best_practices.md`) |
| **Get, list, reschedule, cancel emails** | sending/email_management.md (`references/sending/email_management.md`) |
...
| **Manage API keys** | api_keys.md (`references/api_keys.md`) — permission scoping, domain restrictions |
| **View API request logs** | logs.md (`references/logs.md`) — list and retrieve API call history, debugging |
| **Define contact properties** | contact_properties.md (`references/contact_properties.md`) — custom fields for contacts |
