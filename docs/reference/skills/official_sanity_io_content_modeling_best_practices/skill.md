...
- `references/separation_of_concerns.md` — Separating content from presentation
- `references/reference_vs_embedding.md` — When to use references vs embedded objects
- `references/content_reuse.md` — Content reuse patterns and the reuse spectrum
- `references/taxonomy_classification.md` — Flat, hierarchical, and faceted classification
