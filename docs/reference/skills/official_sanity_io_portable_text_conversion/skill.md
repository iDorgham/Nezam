...
- **Markdown → Portable Text**: `rules/markdown_to_pt.md` — `@portabletext/markdown` with `markdownToPortableText` (recommended)
- **HTML → Portable Text**: `rules/html_to_pt.md` — `@portabletext/block-tools` with `htmlToBlocks`
- **Manual PT Construction**: `rules/manual_construction.md` — build blocks programmatically from any source
