...
- `references/eeat_principles.md` — EEAT implementation and author schema
- `references/structured_data.md` — JSON-LD patterns (Article, FAQ, Breadcrumb, Product)
- `references/technical_seo.md` — Technical SEO checklist (metadata, sitemaps, hreflang, robots.txt)
- `references/aeo_considerations.md` — AI/AEO considerations (AI Overviews, crawler management)
