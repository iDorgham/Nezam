...
- `rules/project_files.md`
- `rules/build_deploy.md`
- `rules/datasource_files.md`
- `rules/pipe_files.md`
- `rules/endpoint_files.md`
- `rules/materialized_files.md`
- `rules/sink_files.md`
- `rules/copy_files.md`
- `rules/connection_files.md`
- `rules/sql.md`
- `rules/endpoint_optimization.md`
- `rules/tests.md`
- `rules/deduplication_patterns.md`
