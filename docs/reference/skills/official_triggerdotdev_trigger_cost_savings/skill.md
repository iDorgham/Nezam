...
Use the fetched content to ensure recommendations are current. If the fetch fails, fall back to the reference documentation in `references/cost_reduction.md`.
...
See `references/cost_reduction.md` for detailed strategies with code examples.
