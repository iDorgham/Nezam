...
- Ensure the PHPStan config references the stubs (see `references/third_party_classes.md`).
...
See:
- `references/wordpress_annotations.md`
...
See:
- `references/third_party_classes.md`
