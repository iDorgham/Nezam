...
- `IA_CONTENT.md`
- `VERSIONING.md`
- `DESIGN.md` (repo root when present, generated from design template)
- `plan/04-harden/perf.md` populated with release budgets and stop conditions
...
| Design | `DESIGN.md` with token/type/motion/3D/component contracts | Design-dev gates satisfied |
| Development | Feature specs + implementation slices | No gate violations in rules |
| Hardening | Perf/a11y evidence in `plan/04-harden/perf.md` | LCP/CLS/INP and WCAG targets pass |