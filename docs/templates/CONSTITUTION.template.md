...
Non-negotiable principles for architecture, quality, and security. Amend via dated decision in `docs/context/MEMORY.md` and linked spec appendix.
...
1. Propose change in a spec or `docs/context/MEMORY.md` with date and rationale.
