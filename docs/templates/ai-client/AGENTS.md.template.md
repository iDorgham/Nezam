...
- **Cross-client map:** [`docs/workspace/context/MULTI_TOOL_INDEX.md`](docs/workspace/context/MULTI_TOOL_INDEX.md)
...
- Execution plans and SDD tasks live under `docs/workspace/plans/` (and optional local `.cursor/plans/` if your team uses Cursor plan files).
